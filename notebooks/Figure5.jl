...
md"
# Figure 5. Idealized Static Energies
"
...
begin
	...
	fig.savefig(plotsdir("fig5-idealizedstaticenergies.png"),transparent=false,dpi=400)
	load(plotsdir("fig5-idealizedstaticenergies.png"))
end
